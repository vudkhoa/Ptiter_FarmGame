...
{
    /// <summary>Giá trị = index vào mảng _slots của CutsceneWindowController nên thứ tự khai báo phải khớp thứ tự kéo slot trong Inspector. Số lớn hơn vẽ đè lên trên.</summary>
